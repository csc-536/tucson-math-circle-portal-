...
function Registration({ update }) {
    ...
    return (
        <form id="regForm" onSubmit={handleFormSubmit}>
            ...
            <p className="regNote">
                NOTE: The email provided below is shared between all students
                associated with this account and will be used to recieve Tucson
                Math Circle meeting reminders and notifications
            </p>
            <p className="regNote">
            ...
            <p className="regNote">
                Fill in the required guardian fields for emergency contact
                purposes
            </p>
            <p className="regNote">
                NOTE: The first (top) guardian listed below will be the primary

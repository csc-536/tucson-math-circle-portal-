    ...
    const consentFormWarning = (
        <div>
            ...
            <Alert severity="warning">
                <AlertTitle>
                    <strong>
                        Attention!!! - Students cannot regisiter meetings till
                        their consent forms are verified.
                    </strong>
                </AlertTitle>
                {unverifiedStudents.map(({ name }, i) =>
                    i === unverifiedStudents.length - 1
                        ? `${name} `
                        : `${name}, `
                )}
                {unverifiedStudents.length > 1 ? "haven't" : "hasn't"} be
                verified yet.
                <br />
                If all consent forms are upload, please wait until coordinators
                verify them.
                <br />
